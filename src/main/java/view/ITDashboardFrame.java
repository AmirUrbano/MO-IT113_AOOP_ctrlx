...
public class ITDashboardFrame extends JFrame{
    ...
    private void initComponents() {
        ...
        logoutBtn = UIComponents.styledButton("Logout", new Color(150, 0, 0));
        ...
        userTable = UIComponents.readOnlyTable(columns);
        ...
        resetBtn = UIComponents.infoButton("Reset Password");
        diagBtn = UIComponents.styledButton("Run Diagnostics", new Color(60, 60, 60));
        refreshBtn = UIComponents.styledButton("Sync Registry", new Color(0, 153, 76));
